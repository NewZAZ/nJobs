...
public class BlockListeners implements Listener {
    ...
    public void onBlockPlace(BlockPlaceEvent event){
        ...
        if(event.getBlockPlaced().getType() == CompatibleMaterial.MELON.getBlockMaterial() || event.getBlockPlaced().getType() == CompatibleMaterial.CARROT.getBlockMaterial() || event.getBlockPlaced().getType() == CompatibleMaterial.POTATO.getBlockMaterial() || event.getBlockPlaced().getType() == CompatibleMaterial.NETHER_WART.getBlockMaterial())return;
