...
public class Reflections {
    ...
    public static final class ReflectBukkitPacket extends ClassPacket {
        public final Reflections.ClassPacket BLOCK;
        public final Reflections.ClassPacket BOSSBAR;
        public final Reflections.ReflectBukkitPacketCommand COMMAND;
        public final Reflections.ClassPacket ENCHANT;
        public final Reflections.ClassPacket ENTITY;
        public final Reflections.ClassPacket EVENT;
        public final Reflections.ClassPacket GENERATOR;
        public final Reflections.ClassPacket HELP;
        public final Reflections.ClassPacket INVENTORY;
        public final Reflections.ClassPacket MAP;
        public final Reflections.ClassPacket METADATA;
        public final Reflections.ClassPacket POTION;
        public final Reflections.ClassPacket PROJECTILES;
        public final Reflections.ClassPacket SCHEDULER;
        public final Reflections.ClassPacket SCOREBOARD;
        public final Reflections.ReflectBukkitPacketUtil UTIL;
        ReflectBukkitPacket(final String arg0) {
            super(arg0);
            this.BLOCK = new Reflections.ClassPacket(this.path + ".block");
            this.BOSSBAR = new Reflections.ClassPacket(this.path + ".boss");
            this.COMMAND = new Reflections.ReflectBukkitPacketCommand(this.path + ".command");
            this.ENCHANT = new Reflections.ClassPacket(this.path + ".enchantments");
            this.ENTITY = new Reflections.ClassPacket(this.path + ".entity");
            this.EVENT = new Reflections.ClassPacket(this.path + ".event");
            this.GENERATOR = new Reflections.ClassPacket(this.path + ".generator");
            this.HELP = new Reflections.ClassPacket(this.path + ".help");
            this.INVENTORY = new Reflections.ClassPacket(this.path + ".inventory");
            this.MAP = new Reflections.ClassPacket(this.path + ".map");
            this.METADATA = new Reflections.ClassPacket(this.path + ".metadata");
            this.POTION = new Reflections.ClassPacket(this.path + ".potion");
            this.PROJECTILES = new Reflections.ClassPacket(this.path + ".projectiles");
            this.SCHEDULER = new Reflections.ClassPacket(this.path + ".scheduler");
            this.SCOREBOARD = new Reflections.ClassPacket(this.path + ".scoreboard");
            this.UTIL = new Reflections.ReflectBukkitPacketUtil(this.path + ".util");
        }
        @Override
    ...
    public static final class ReflectBukkitPacketCommand extends ClassPacket {
        ...
        ReflectBukkitPacketCommand(final String arg0) {
            super(arg0);
            this.DEFAULTS = new Reflections.ClassPacket(this + ".defaults");
        }
    }
    public static final class ReflectBukkitPacketUtil extends ClassPacket {
        public final Reflections.ClassPacket PERMISSION;
        ReflectBukkitPacketUtil(final String arg0) {
            super(arg0);
            this.PERMISSION = new Reflections.ClassPacket(this + ".permissions");
        }
    }
    public static class ClassPacket {
        protected final String path;
        ClassPacket(final String arg0) {
            this.path = arg0.replace("[VERSION]", Reflections.getPackageVersion());
        }
