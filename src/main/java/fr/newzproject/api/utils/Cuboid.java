...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    public Cuboid(Map<String, Object> map) {
        ...
        this.x1 = (java.lang.Integer) map.get("x1");
        this.x2 = (java.lang.Integer) map.get("x2");
        this.y1 = (java.lang.Integer) map.get("y1");
        this.y2 = (java.lang.Integer) map.get("y2");
        this.z1 = (java.lang.Integer) map.get("z1");
        this.z2 = (java.lang.Integer) map.get("z2");
    }
    ...
    public List<Block> getPerimeter() {
        ...
        while (z < sizeZ) {
            if (isBorder(z, sizeZ, x, sizeX)) {
                blocks.add(this.getWorld().getBlockAt(this.x1 + x, this.y1, this.z1 + z));
            }
            x++;
            if (x == sizeX) {
                x = 0;
    ...
    private boolean isBorder(int z, int zMax, int x, int xMax) {
        if (z == 0 || z == zMax - 1) {
            return true;
        }
        if (z > 0 && z < zMax) {
